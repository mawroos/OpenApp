...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.greet = function () {
        return __awaiter(this, void 0, void 0, function () {
            var dimensions, measures, input, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dimensions = [JSON.stringify({ Name: "Co" }), JSON.stringify({ Name: "SellingLocation" })];
                        measures = [JSON.stringify({ Name: "Sales", ColumnName: "NetSales", AggregationType: 0 })];
                        input = {
                            dimensions: dimensions,
                            measures: measures
                        };
                        return [4 /*yield*/, abp.services.app.demo1Service.getData2(input)];
                    case 1:
                        results = _a.sent();
